...
function store(rooms) {
  ...
  localStorage.setItem("ilovepobi", serialized); 
}

function retreive() {
  // deserializeation
  var rawObjects = JSON.parse(localStorage.getItem("ilovepobi"));
  var resultRooms = [];
...
function initializeExampleRooms() {
  var rooms = [
    new Room(108, 356, 100, 40, "Room 305", null), 
    new Room(216, 356, 100, 40, "Room 306", null),
    new Room(341, 356, 100, 40, "Room 307", null),
    new Room(578, 356, 100, 40, "Suite Room Classroom", null), 
    new Room(341, 520, 100, 40, "Room 304", null),
    new Room(447, 520, 100, 40, "Front Office", null), 
    new Room(551, 520, 100, 40, "Room 303", null), 
    new Room(691, 520, 100, 40, "Room 302", null), 
    new Room(823, 520, 100, 40, "Room 301", null), 
  ];
