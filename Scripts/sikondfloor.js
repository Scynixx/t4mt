...
function store(rooms) {
  ...
  localStorage.setItem("rooms2ndFloor", serialized); 
}

function retreive() {
  // deserializeation
  var rawObjects = JSON.parse(localStorage.getItem("rooms2ndFloor"));
  var resultRooms = [];
...
function initializeExampleRooms() {
  var rooms = [
    new Room(170, 395, 100, 40, "Room 205", null), 
    new Room(346, 395, 100, 40, "Room 206", null),
    new Room(634, 395, 100, 40, "Chemistry Lab.", null),
    new Room(502, 574, 100, 40, "Tech. Lab", null), 
    new Room(331, 574, 100, 40, "Room 204", null),
    new Room(195, 574, 100, 40, "Room 203", null), 
    new Room(662, 574, 100, 40, "Room 202", null), 
    new Room(801, 574, 100, 40, "Room 201", null),  
  ];
